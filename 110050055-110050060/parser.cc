// Generated by Bisonc++ V2.09.03 on Sun, 30 Mar 2014 20:58:41 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {297, 2}, // 18: executable_statement_list ->  assignment_statement_list if_expression
     {297, 2}, // 19: executable_statement_list ->  assignment_statement_list goto_expression
     ...
     {299, 4}, // 22: assignment_statement (ASSIGN) ->  variable ASSIGN comparision_expression ';'
     {300, 1}, // 23: variable (NAME) ->  NAME
     {301, 1}, // 24: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {302, 3}, // 25: goto_expression (GOTO) ->  GOTO BBNUM ';'
     {303, 11}, // 26: if_expression (IF) ->  IF '(' comparision_expression ')' GOTO BBNUM ';' ELSE GOTO BBNUM ';'
     {304, 3}, // 27: comparision_expression (LEP) ->  comparision_expression LEP comparision_expression
     {304, 3}, // 28: comparision_expression (LTP) ->  comparision_expression LTP comparision_expression
     {304, 3}, // 29: comparision_expression (GEP) ->  comparision_expression GEP comparision_expression
     {304, 3}, // 30: comparision_expression (GTP) ->  comparision_expression GTP comparision_expression
     {304, 3}, // 31: comparision_expression (NEP) ->  comparision_expression NEP comparision_expression
     {304, 3}, // 32: comparision_expression (EQP) ->  comparision_expression EQP comparision_expression
     {304, 1}, // 33: comparision_expression ->  variable
     {304, 1}, // 34: comparision_expression ->  constant
     {304, 3}, // 35: comparision_expression ('(') ->  '(' comparision_expression ')'
...
SR__ s_26[] =
{
    { { REQ_DEF}, {   9} },                        
    { {     260}, {  27} }, // RETURN              
    { {     303}, {  28} }, // if_expression       
    { {     302}, {  29} }, // goto_expression     
    { {     299}, {  30} }, // assignment_statement
    { {     262}, {  31} }, // IF                  
    { {     264}, {  32} }, // GOTO                
    { {     300}, {  33} }, // variable            
    { {     259}, {  34} }, // NAME                
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        case 25:
        {
         ...
         d_val__.ast = new Goto_Ast(d_vsp__[-1].integer_value, line);
         }
         }
        break;
        ...
        case 26:
        {
         if(NOT_ONLY_PARSE)
         {
         d_val__.ast = new If_Else_Ast(d_vsp__[-8].ast, d_vsp__[-5].integer_value, d_vsp__[-1].integer_value, get_line_number());
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 27:
        {
         if(NOT_ONLY_PARSE)
         {
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, LE, get_line_number());
        ...
        case 28:
        {
         ...
         {
         int line = get_line_number();
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, LT, line);
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 29:
        {
         ...
         {
         int line = get_line_number();
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, GE, line);
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 30:
        {
         ...
         {
         int line = get_line_number();
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, GT, line);
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 31:
        {
         ...
         {
         int line = get_line_number();
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, NE, line);
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 32:
        {
         ...
         {
         int line = get_line_number();
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, EQ, line);
         d_val__.ast->check_ast();
         }
         }
        break;
