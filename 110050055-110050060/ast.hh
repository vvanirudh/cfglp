...
class Relational_Expr_Ast:public Ast
{
	...
	relation_op op;
public:
	Relational_Expr_Ast(Ast * arg_lhs, Ast * arg_rhs, relation_op arg_op, int line);
	~Relational_Expr_Ast();
...
public:
	int successor;
	Goto_Ast(int arg_successor, int line);
	~Goto_Ast();
...
class If_Else_Ast:public Ast
{
	...
	int false_successor;
public:
	If_Else_Ast(Ast * arg_condition, int arg_true_successor, int arg_false_successor, int line);
	~If_Else_Ast();
